...
function startGulp(name, opts) {
  ...
  var buildPath = './node_modules/bitcore-build-innova/';
  ...
  if (browser) {
    ...
    if (name !== 'lib') {
      browserifyCommand = browserifyPath + ' --require ./index.js:' + fullname + ' --external bitcore-lib-innova -o ' + fullname + '.js';
    } else {
      browserifyCommand = browserifyPath + ' --require ./index.js:bitcore-lib-innova -o bitcore-lib-innova.js';
    }
